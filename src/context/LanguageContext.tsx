...
export const TRANSLATIONS = {
  en: {
    ...
    "Created": "Created",
    "Status updated — you're now En Route 🚗": "Status updated — you're now En Route 🚗",
    "Marked as Arrived ✓": "Marked as Arrived ✓",
    "Work started ⚙️": "Work started ⚙️",
    ...
    "Loading Live Tracker...": "Loading Live Tracker...",
    "Live Navigation": "Live Navigation",
    "Locating you...": "Locating you...",
    "Distance": "Distance",
    "Job Location": "Job Location",
    "You are here": "You are here",
    "I've Arrived at Location": "I've Arrived at Location",
    "ETB per unit": "ETB per unit",
    "Failed to fetch recommendation.": "Failed to fetch recommendation.",
    "Failed to fetch recommendation for this job.": "Failed to fetch recommendation for this job.",
    "Failed to fetch recommendation details.": "Failed to fetch recommendation details.",
    "No recommendation found for this job.": "No recommendation found for this job.",
    "Recommendation sent to driver for approval.": "Recommendation sent to driver for approval.",
  ...
  am: {
    ...
    "Created": "የተፈጠረበት",
    "Status updated — you're now En Route 🚗": "የስራ ሁኔታ ተዘምኗል — አሁን በመንገድ ላይ ነዎት 🚗",
    "Marked as Arrived ✓": "ደርሰዋል ተብሎ ምልክት ተደርጓል ✓",
    "Work started ⚙️": "ስራ ተጀምሯል ⚙️",
    "Job completed! 🎉": "ስራው ተጠናቅቋል! 🎉",
    "Status →": "የስራ ሁኔታ →",
    "Failed to update status.": "ሁኔታውን ማዘመን አልተቻለም።",
    "Job": "ስራ",
    "Draft": "ረቂቅ",
    "Sent": "ተልኳል",
    // "Approved": "ጸድቋል",
    ...
    "Loading Live Tracker...": "የቀጥታ መከታተያ በመጫን ላይ...",
    "Live Navigation": "የቀጥታ አቅጣጫ መጠቆሚያ",
    "Locating you...": "ቦታዎን በመለየት ላይ...",
    "Distance": "ርቀት",
    "Job Location": "የስራ ቦታ",
    "You are here": "እርስዎ እዚህ ነዎት",
    "I've Arrived at Location": "ቦታው ላይ ደርሻለሁ",
    "ETB per unit": "ብር በአንድ ክፍል",
    "Failed to fetch recommendation.": "ምክረ ሃሳብ ማምጣት አልተቻለም።",
    "Failed to fetch recommendation for this job.": "ለዚህ ስራ ምክረ ሃሳብ ማምጣት አልተቻለም።",
    "Failed to fetch recommendation details.": "የምክረ ሃሳብ ዝርዝሮችን ማምጣት አልተቻለም።",
    "No recommendation found for this job.": "ለዚህ ስራ ምንም ምክረ ሃሳብ አልተገኘም።",
    "Recommendation sent to driver for approval.": "ምክረ ሃሳቡ ለአሽከርካሪው እንዲጸድቅ ተልኳል።",
    "Failed to load history.": "የስራ ታሪክን መጫን አልተቻለም።",
    "Unable to connect to server. Please try again.": "ከአገልጋዩ ጋር መገናኘት አልተቻለም። እባክዎ እንደገና ይሞክሩ።",
  }
};
