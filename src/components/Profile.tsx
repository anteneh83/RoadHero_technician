    ...
    <div className="min-h-full pb-8">
      ...
      <div className="relative pt-10 pb-16 px-4 overflow-hidden"
        ...
        <div className="relative flex flex-col items-center">
          ...
          <h2 className="text-2xl font-black" style={{ color: "#f1f5f9" }}>{profile.full_name || "Technician"}</h2>
          <p className="text-sm mt-1" style={{ color: "#64748b" }}>{profile.phone_number}</p>
          ...
          <div className="mt-3 flex items-center gap-2 px-3 py-1.5 rounded-full"
            ...
            <span className="text-xs font-semibold" style={{ color: profile.is_active ? "#34d399" : "#64748b" }}>
      ...
      <div className="px-4 -mt-8 space-y-4">
        ...
        {/* Specialties */}
        <div className="rounded-2xl p-5 animate-slide-up"
          style={{ animationDelay: "0.05s", background: "rgba(20,28,46,0.9)", border: "1px solid rgba(148,163,184,0.1)" }}>
        ...
        <div className="grid grid-cols-2 gap-3 animate-slide-up" style={{ animationDelay: "0.1s" }}>
          {/* Rating */}
          <div className="rounded-2xl p-4" style={{ background: "rgba(20,28,46,0.9)", border: "1px solid rgba(148,163,184,0.1)" }}>
            <div className="w-8 h-8 rounded-lg flex items-center justify-center mb-3"
              style={{ background: "rgba(245,158,11,0.15)" }}>
              <Star className="w-4 h-4" style={{ color: "#f59e0b" }} />
            </div>
            <p className="text-2xl font-black" style={{ color: "#f1f5f9" }}>{ratingDisplay}</p>
            <p className="text-xs mt-1 font-medium" style={{ color: "#475569" }}>Rating</p>
          </div>
          ...
          <div className="rounded-2xl p-4" style={{ background: "rgba(20,28,46,0.9)", border: "1px solid rgba(148,163,184,0.1)" }}>
            ...
            <p className="text-xs mt-1 font-medium" style={{ color: "#475569" }}>Status</p>
          </div>
        </div>

        {/* Specialties count */}
        <div className="rounded-2xl p-4 animate-slide-up" style={{ animationDelay: "0.12s", background: "rgba(20,28,46,0.9)", border: "1px solid rgba(148,163,184,0.1)" }}>
